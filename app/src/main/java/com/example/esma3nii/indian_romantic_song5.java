...
public class indian_romantic_song5 extends AppCompatActivity {
    MediaPlayer m;
    SeekBar s;
    TextView t1 ,t2 ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_indian_romantic_song5);
        t1=findViewById(R.id.t1);
        t2=findViewById(R.id.t2);
        getSupportActionBar().hide();
        s=findViewById(R.id.seekBar);
        m=MediaPlayer.create(this, R.raw.song5);
