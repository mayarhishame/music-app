    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        img2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(arabic_songs.this,arabic_songs_list.class);
                startActivity(i);
            }
        });
        ...
        img3.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent i = new Intent(arabic_songs.this,arabic_rab_list_songs.class);
                    startActivity(i);
                }
        });
        ...
        img4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(arabic_songs.this,arabic_sad_songs_list.class);
                startActivity(i);
            }
        });
        ...
        img5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(arabic_songs.this,arabic_romantic_songs_list.class);
                startActivity(i);
            }
        });
    }
